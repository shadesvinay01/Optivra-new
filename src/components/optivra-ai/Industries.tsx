...
const INDUSTRIES = [
  ...
  { icon: ShoppingBag, name: "Retail", useCases: "Personalized recommendations, inventory forecasting, support" },
  ...
  { icon: Truck, name: "Logistics", useCases: "Route optimization, fleet tracking, document processing" },
  { icon: Hotel, name: "Hospitality", useCases: "Guest booking, concierge services, dynamic pricing" },
  { icon: Scale, name: "Legal", useCases: "Contract review, case research, document summarization" },
  { icon: Briefcase, name: "Agencies", useCases: "Client reporting, content generation, campaign optimization" },
];
    ...
    <section id="industries" className="py-32 px-6 max-w-7xl mx-auto z-10 relative">
      <div className="text-center mb-16">
        <h2 className="text-4xl font-black text-white tracking-tighter mb-4">
          Built for <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-400">Your Industry.</span>
        </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
        {INDUSTRIES.map((ind, i) => (
          <motion.div
            ...
            className="p-6 rounded-2xl bg-white/[0.02] border border-white/5 hover:bg-white/[0.05] hover:border-indigo-500/30 transition-all flex flex-col group cursor-default"
          >
            <ind.icon className="w-8 h-8 text-indigo-400 mb-4 group-hover:scale-110 transition-transform" />
